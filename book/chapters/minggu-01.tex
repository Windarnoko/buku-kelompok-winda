...
\begin{figure}[htbp]
  \catering
  \includegraphics[width=0.85\linewidth]{book/assets/images/minggu-01/vs-code-index.html.png}
  \caption{VS Code dengan file \texttt{index.html} terbuka.}
  \label{fig:vs-code-index}
\end{figure}

\begin{tangkapanlayar}
  {book/assets/images/minggu-01/browser-halo-dunia.png}
  {Peramban menampilkan hasil ``Halo, Dunia!''}
  {Pastikan URL di bilah alamat dimulai dengan \texttt{127.0.0.1:5500}.}
\end{tangkapanlayar}
...
\begin{tangkapanlayar}
  {book/assets/images/minggu-01/dashboard-github.png}
  {Dashboard GitHub setelah berhasil login.}
  {Pastikan username terlihat di pojok kanan atas.}
\end{tangkapanlayar}
...
\begin{tangkapanlayar}
  {assets/images/minggu-01/repository-github.png}
  {Halaman repository GitHub \texttt{latihan-web-1}.}
  {Pastikan file \texttt{index.html} terlihat di daftar file.}
\end{tangkapanlayar}
...
\begin{tangkapanlayar}
  {book/assets/images/minggu-01/perbandingan-url.png}
